-- Create the private KYC documents storage bucket and policies.
-- Run this in Supabase Dashboard → SQL Editor if registration fails with
-- "Bucket not found" when uploading Aadhaar/PAN images.
